...
for (var i = 0; i < numArray.length; i++) {
   if (11 === numArray[i]) {
     var position = numArray.indexOf(i);
     alert(i);
   }
 }
...
for (var i = 0; i < numArray.length; i++) {
  ...
  if (numArray[i] > 50) {
    //var total = numArray[i].reduce(getSum);
    //var sum = numArray.reduce(function(a, b) { return a + b; });
    newArray.push(numArray[i]);
   }
   
 }
  var sumLessThan = newArray.reduce(function(a, b) { return a + b; });
 
 console.log(sumLessThan);
...
// // We've declared this array for you
// var fruits = ["Apple", "Orange", "Banana", "Pomelo", "Apple", "Kiwi", "Peach", "Banana", "Grape", "Tomato", 
...
//function myFunction("Apple", 0, fruits) {
//    txt = txt + value + "<br>"; 
// }
