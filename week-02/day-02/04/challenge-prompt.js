...
function warble (placeHolder) {
    return placeHolder + " arglebargle";
}
...
function noMathSum (placeHolder1, placeHolder2, placeHolder3) {
    ...
    var placeHolder4 = returnSum(placeHolder1, placeHolder2);
    console.log(placeHolder4);
   return returnSum(placeHolder4, placeHolder3);
   
}

console.log(noMathSum(1, 2, 3));


// define a function "danceParty" that takes in a string as an argument,
// creates an alert that says "dance!",
// saves the result of calling your "wibbly" function with that argument, <--- Wasn't totally sure what was meant by 'that argument'
// saves the result of calling your "warble" function with that argument, <--- Wasn't totally sure what was meant by 'that argument'
// concatenates the two results together and returns that string
function danceParty (placeHolder) {
    alert("dance!");
    var firstText = wibble(placeHolder);
    var secondText = warble(placeHolder);
