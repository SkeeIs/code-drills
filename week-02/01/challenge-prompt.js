...
var statementOne = "Programmers: " + firstName + " " + lastName + " is a " + nationality + " " + profession + " born in " + birthYear + ".";
...
var statementTwo = "She is commonly reffered to as the the " + knownFor + ".";
...
var statementThree = "In " + yearOfPublish + " she published the first Algorithm, the " + firstAlgorithm + ", at the age of 27."
