...
function totalBill(preTaxAndTipAmount) {
  // your code here
  var addTax = preTaxAndTipAmount * .095 + preTaxAndTipAmount * .15 + preTaxAndTipAmount;
  return addTax;
}
